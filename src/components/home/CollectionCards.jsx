      ...
      <div className="relative w-full">
        <div className="pb-6 pt-4 sm:pb-8 sm:pt-6 lg:pb-10">
          <div className="relative min-w-0 max-w-full pl-12 sm:pl-14 lg:pl-16 xl:pl-20">
            ...
            <div className="flex w-full min-w-0 items-start justify-center gap-2 pb-2 sm:gap-3 md:gap-4 lg:justify-end lg:pb-0">
                  ...
                  >
                    ...
                    {isActive ? (
                      <div className="flex flex-col gap-4 bg-[#0E0E0E] px-4 py-5 text-white sm:flex-row sm:items-center sm:justify-between sm:gap-3 sm:px-6 sm:py-6">
                        ...
                        <motion.button
                          type="button"
                          className="w-full shrink-0 rounded-full border border-white px-5 py-3 text-center text-base font-medium transition-[background-color,box-shadow] duration-300 ease-out hover:cursor-pointer hover:bg-white/10 sm:my-auto sm:w-auto sm:self-start sm:px-6 sm:py-3.5 sm:text-lg lg:px-8"
